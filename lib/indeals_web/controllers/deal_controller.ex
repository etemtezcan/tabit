...
#      salary_ranges: Application.get_env(:indeals, :salary_ranges),
      status: ""
  end

  defp get_locations() do
    Application.get_env(:indeals, :locations)
